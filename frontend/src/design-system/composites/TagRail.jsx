  ...
  return (
    <div className="mt-[18px]">
      <div className="flex items-center gap-2.5">
        <div className="flex gap-2 overflow-x-auto overflow-y-hidden pb-[6px] flex-1 min-w-0 [scrollbar-width:thin] [scrollbar-color:var(--color-scrollbar-track)_transparent]">
          {tags.map((tag) => {
