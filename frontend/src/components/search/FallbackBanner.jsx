export default function FallbackBanner({ suggestedTags, onPickTag }) {
  return (
    <div className="flex gap-[13px] border-l-2 border-accent-warning bg-[rgba(217,167,46,0.06)] rounded-r-[10px] px-[17px] py-[15px] mb-[18px]">
      ...
      <div>
        ...
        <p className="text-[#c4b896] text-[12.5px] leading-[1.55] m-0">
        ...
        {suggestedTags.length > 0 && (
          <div className="flex items-center gap-2 flex-wrap mt-3">
            <span className="font-mono text-[11px] text-[#9a8e68]">browse instead:</span>
